...
bot = telebot.TeleBot('7742970585:AAHeJMJ9C0ASq3ixf_0kOQFl8wSYP46yG2k')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "You have not purchased yet purchase now from:- @Bgmi_owner_420✅."
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @Bgmi_owner_420✅ 🙇."
    bot.reply_to(message, response)
...
def run_attack_and_notify(message, user_id, target, port, time):
    ...
    if success:
        ...
        bot.reply_to(message, "*Your Attack is Finished Please Send Feedback With @Ddos_wala*")
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command. DM TO BUY ACCESS:- @Bgmi_owner_420✅"
